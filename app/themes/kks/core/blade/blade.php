...
class Blade 
{
    ...
    */
    ...
    /**
     * Compile Blade dot-notation arrays into valid PHP.
     *
     * @param  string  $value
     * @return string
     */
    ...
    */
    ...
    /**
     * Compile Blade module statements into valid PHP.
     *
     * @param  string  $value
     * @return string
     */
    protected function compileModule( $value )
    {
        $pattern = $this->createOpenMatcher('module');
        ...
        foreach( $files as $key => $file )
        {
            ...
            $located = $this->locateFile( preg_replace( "/[\"\'\s]*/", "", MODULES_DIR . '/' . $file ) );
     ...
     * @return string
     */
    protected function compileView( $value )
    {
        $pattern = $this->createOpenMatcher('view');
        ...
        foreach( $files as $key => $file )
        {
            ...
            $located = $this->locateFile( preg_replace( "/[\"\'\s]*/", "", VIEWS_DIR . '/' . $file ) );
    ...
    /**
     * Compile Blade Layout statements into valid PHP.
     *
     * @param  string  $value
     * @return string
     */
    protected function compileLayout( $value )
    {
        $pattern = $this->createOpenMatcher('layout');
        preg_match_all( $pattern, $value, $matches );

        $class = reset( $matches[2] );
        $replace = '<?php $layout = ' . $class . '; ?>';
